    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <ChapterOption
            ...
            onCreate={() => setShowChapterCreator(true)}
            onDelete={
              onDeleteChapter
                ? async (id) => {
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex flex-1 min-h-0">
          ...
          <div
            className={clsx(
              "w-45 border-r border-slate-100 p-2",
              "flex flex-col shrink-0 bg-white overflow-y-auto",
      ...
      {showChapterCreator && onCreateChapter && (
        <ChapterCreatorModal
          comicInfo={comicInfo}
          onCreateChapter={async (subtitle) => {
