use poprako_entity::member::{ActiveModel, Column, Entity, Model};
use sea_orm::{ActiveModelTrait, ConnectionTrait, DbErr, EntityTrait, PaginatorTrait, QueryOrder};

/// # 功能
/// member_table 仓储入口，聚合 `member_table` 表的 CRUD 与按 ID 查询。
...
impl MemberRepository {
    /// # 功能
    /// 读取 `member_table` 全部行，按 `created_at` 升序返回。
    ///
    /// ## 参数
